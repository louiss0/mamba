...
final class CommandRegistry {
  ...
  bool operator ==(Object other) {
    return other is CommandRegistry &&
        name == other.name &&
        shortDescription == other.shortDescription &&
        longDescription == other.longDescription &&
        _mapsEqual(boolFlags, other.boolFlags) &&
        _mapsEqual(countFlags, other.countFlags) &&
        _mapsEqual(options, other.options) &&
        _mapsEqual(positionals, other.positionals) &&
        variadic == other.variadic &&
        _mapsEqual(accessors, other.accessors) &&
        _listsEqual(commandRegistries, other.commandRegistries) &&
  ...
  int get hashCode => Object.hashAll([
    ...
    _mapHash(countFlags),
    _mapHash(options),
    _mapHash(positionals),
    variadic,
    _mapHash(accessors),
    commandRegistries == null ? null : Object.hashAll(commandRegistries!),
    aliases == null ? null : Object.hashAll(aliases!),
  ]);
  ...
  static bool _listsEqual(List<Object?>? left, List<Object?>? right) {
    if (identical(left, right)) {
      return true;
    }
    if (left == null || right == null || left.length != right.length) {
    ...
    return left.indexed.every((entry) => entry.$2 == right[entry.$1]);
  }

  static int? _mapHash(Map<Object?, Object?>? map) {
    if (map == null) {
      return null;
    }
    return map.entries.fold<int>(
      0,
