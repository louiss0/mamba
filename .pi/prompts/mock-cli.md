...
Write tests before implementation when adding behavior. Run formatting, static analysis, and the focused fixture tests. Generate supported completion artifacts into the fixture's `completions` directory, and report any limitation of the parser or completion integration.
