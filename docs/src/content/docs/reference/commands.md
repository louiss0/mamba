...
They are the kinds of commands that can use [normal hooks](/references/hooks).

## Group Command

A group command is a command that allows other commands to be nested within it.
It can have it's own [flags](/references/flags) and [options](references/options). 
...
These kinds of commands can run [persistent](/references/hooks#persistent-hooks) and [normal hooks](/references/hooks#normal-hooks)
